...
public class SandwichBar {
	...
	public int whichOrder(String[] available, String[] orders) {
		...
		if("cat" == user) {
			...
			order = whichOrderChris(available, orders);
		}
	...
	public static void main(String[] args) {
		...
		System.out.println("Cat:   " + elapsed);
		...
		elapsed = System.nanoTime() - start;
		System.out.println("Chris: " + elapsed + " (lower is better)");
	}
	...
	public static void test(String user) {
		...
		if(result == expectation) {
			...
			failed++;
			System.out.println("Example 13: expected result " + result + " to be " + expectation);
		}
